...
extension DurationExtension on BuildContext {
  ...
  Duration get durationExtraExtraSlow => const Duration(seconds: 5);
}
...
extension SizedBoxExtension on BuildContext {
  ...
  Widget get emptySizedWidthBoxNormal2x =>
      const SpaceSizedWidthBox(width: 0.06);
  Widget get emptySizedWidthBoxNormal3x =>
      const SpaceSizedWidthBox(width: 0.07);
  Widget get emptySizedWidthBoxNormal4x =>
      const SpaceSizedWidthBox(width: 0.08);
  Widget get emptySizedWidthBoxHigh => const SpaceSizedWidthBox(width: 0.09);
  Widget get emptySizedWidthBoxHigh2x => const SpaceSizedWidthBox(width: 0.1);
  Widget get emptySizedWidthBoxHigh3x => const SpaceSizedWidthBox(width: 0.15);
  Widget get emptySizedWidthBoxHigh4x => const SpaceSizedWidthBox(width: 0.2);
  ...
  Widget get emptySizedHeightBoxNormal2x =>
      const SpaceSizedHeightBox(height: 0.06);
  Widget get emptySizedHeightBoxNormal3x =>
      const SpaceSizedHeightBox(height: 0.07);
  Widget get emptySizedHeightBoxNormal4x =>
      const SpaceSizedHeightBox(height: 0.08);
  Widget get emptySizedHeightBoxHigh => const SpaceSizedHeightBox(height: 0.09);
  Widget get emptySizedHeightBoxHigh2x =>
      const SpaceSizedHeightBox(height: 0.1);
  Widget get emptySizedHeightBoxHigh3x =>
      const SpaceSizedHeightBox(height: 0.015);
  Widget get emptySizedHeightBoxHigh4x =>
      const SpaceSizedHeightBox(height: 0.2);
}
